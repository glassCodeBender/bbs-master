...
"SEII.EXE" -> "seii.exe is a process belonging to an advertising program by Clickspring LLC.  This also prompts advertising popups.",
...
"SENG.DLL" -> "seng.dll is a process belonging to the AdShooter.SearchForIt advertising program by Search For It Inc. This module monitors your browsing habits and distributes the data back to the author's servers for analysis.Adware or Spyware",
...
"SERVERSIDE.DLL" -> "serverside.dll is a module belonging to an advertising program by Powerscan. This module monitors your browsing habits and distributes the data back to the author's servers for analysis.Adware or Spyware",
...
"SFBHO.DLL" -> "sfbho.dll is a module belonging to an advertising program by 180Solutions. This module monitors your browsing habits and distributes the data back to the author's servers for analysis.Adware or Spyware",
"SFC.DLL" -> "Windows File Protection  ",
"SFC32.EXE" -> "sfc32.exe is a process which is registered as W32.Monikey@mm Worm.",
...
"SFXD0S2P.EXE" -> "sfxd0s2p.exe is an alternative name for the PLAY_MP3 trojan.",
...
"SHCTXMNUDLL.DLL" -> "shctxmnudll.dll is a module belonging to Security BOX Freeware from Methode et Solution Informatique S.A.",
...
"SHELL32.DLL" -> "Tells us that this program can launch other programs. Common in both malware and common programs.",
"SHELL32.EXE" -> "shell32.exe is a process which is registered as the BadSector virus Trojan. This Trojan allows attackers to access your computer from remote locations",
"SHELL386.EXE" -> "shell386.exe is a process which is registered as a trojan. This Trojan allows attackers to access your computer from remote locations",
...
"SHINE.EXE" -> "shine.exe is a process which is registered as HAPPYLOW virus. This Trojan allows attackers to access your computer from remote locations",
...
"SHLHOOK.DLL" -> "shlhook.dll is a process belonging to the Ace Spy advertising program by Retina-X Studios. This module monitors your browsing habits and distributes the data back to the author's servers for analysis.Adware or Spyware",
...
"SHNLOG.EXE" -> "shnlog.exe is a process added by the Troj/Puper-A Trojan.",
...
"SIPSPI32.DLL" -> "sipspi32.dll is an advertising program by WinSoftware. This module monitors your browsing habits and distributes the data back to the author's servers for analysis.Adware or Spyware",
...
"SKSOCKSERVER.EXE" -> "sksockserver.exe is a process registered as a backdoor vulnerability which may be installed for malicious purposes by an attacker.",
...
"SKYNETAVE.EXE" -> "skynetave.exe is a process which is registered as SASSER WORM. It takes advantage of the Windows LSASS vulnerability",
...
"SKYPE32.EXE" -> "skype32.exe is a process which is registered as W32.Mytob.ML@mm Worm. This virus is distributed via the Internet through e-mail and comes in the form of an e-mail message",
